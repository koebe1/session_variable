...
sessvars.test = {name: "test", age: 100}
console.log(sessvars.test)
sessvars.$.prefs.crossDomain = "true"
console.log("The option for other domains using this library to see your session variables is set to: " + sessvars.$.prefs.crossDomain)
